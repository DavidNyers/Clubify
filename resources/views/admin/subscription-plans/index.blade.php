                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="mb-4 flex flex-col sm:flex-row justify-between items-center gap-4">
                        ...
                        <form action="{{ route('admin.subscription-plans.index') }}" method="GET"
                            ...
                            <input type="text" name="search" id="search" placeholder="Plan suchen..."
                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            <thead
                                ...
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-3">Intervall</th>
                                ...
                                @forelse ($subscriptionPlans as $plan)
                                    <tr
                                        ...
                                        <th scope="row"
                                            ...
                                            {{ $plan->name }}</th>
                                        <td class="px-6 py-4">{{ $plan->getFormattedPrice() }}</td>
                                        <td class="px-6 py-4">{{ $plan->getIntervalLabel() }}</td>
                                        ...
                                        <td class="px-6 py-4 text-right flex justify-end space-x-2">
                                            ...
                                            <form action="{{ route('admin.subscription-plans.destroy', $plan) }}"
                                                method="POST"
                                                onsubmit="return confirm('Sind Sie sicher? Dadurch könnten bestehende Abonnements beeinträchtigt werden!');">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"
                                ...
                                @empty
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                        <td colspan="6"
                                            ...
                                            Keine Abo-Pläne für "{{ request('search') ?? 'alle' }}" gefunden.
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
